...
class Dislike404_Admin_Bar
{
    ...
    public function enqueue_assets(): void
    {
        ...
        wp_localize_script('dislike404-admin-bar', 'dislike404Bar', [
            ...
            'i18n'        => [
                // buttons
                'default' => __('Scan Now', 'dislike404'),
                'initiating'    => __('Starting scan...', 'dislike404'),
                'running'       => __('Scan: ', 'dislike404'),
                'no_errors'     => __('No errors', 'dislike404'),
                'errors_found'  => __('Errors found', 'dislike404'),
                'error'         => __('Something went wrong. Please try again.', 'dislike404'),
                'error_auth'    => __('Invalid API token', 'dislike404'),
                // tooltips
                'tooltip_default'   => __('Scan your website now with dislike404.com', 'dislike404'),
                'tooltip_initiating'   => __('Scan queued - dislike404.com', 'dislike404'),
                'tooltip_running'   => __('Scan in progress. Errors found: ', 'dislike404'),
                'tooltip_running_crawled_pages'   => __(' Crawled Pages: ', 'dislike404'),
                'tooltip_no_errors' => __('No errors found in the last scan - dislike404.com', 'dislike404'),
                'tooltip_errors_found'    => __('Click to view the full report - dislike404.com', 'dislike404'),
                'tooltip_error' => __('dislike404.com: Something went wrong. Please try again  - dislike404.com', 'dislike404'),
                'tooltip_error_auth'    => __('Invalid API token. Please check your plugin settings  - dislike404.com', 'dislike404'),
            ],
        ]);
    }
